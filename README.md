...
## Directory Structure
app/ - root
todos/ - core ToDo CRUD logic
dmd_app/ - secondary app with Markdown

```
admin.py: This file contains configuration for the Django admin interface.
apps.py: This file contains application-specific configuration.
models.py: This file contains the data models for the application.
tests.py: This file contains unit tests for the application.
views.py: This file contains the view functions or classes that handle HTTP requests and return responses.
manage.py: This is a command-line utility for interacting with your Django project. It allows you to run development servers, create database migrations, and more.
settings.py: This file contains project-wide settings for your Django project.
urls.py: This file contains URL patterns for your Django project.
...
templates/: This directory contains HTML templates used by the views in the application.
```
